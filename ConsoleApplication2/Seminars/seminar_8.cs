using System;
using System.Linq;
using ConsoleApplication2.utils;

namespace ConsoleApplication2.Seminars
{
    public class seminar_8
    {
        private static Menu _menu = new Menu();
        public static int[,] SpiralArrayFill(int input)
        {
        ...
        public static int[,] CreateAAndPrintMatrix(int cols, int rows)
        {
            Console.WriteLine();
        ...
        public static int[,] BubbleSortingToDown(int cols, int rows)
        {
